...
module.exports = function(app) {
    ...
    app.post('/ajax_search', function(req, res){
      ...
      if (req.method === 'POST') {
            req.on('data', function (data) {
                ...
                var n_city = JSON.parse(data).c_id;
                var n_section = JSON.parse(data).s_id;
          ...
          /*      var c_id = JSON.parse(data).id;
                ...
                sec = {
                  section: (function() {
                        ...
                        var i;
                        console.log(c_id);
                        for (i = 0; i < reg_code[c_id].reg.length ; i++) {
                            arr.push({
                                c_id: c_id,
                                id: reg_code[c_id].reg[i].id,
                                name: reg_code[c_id].reg[i].name
                            });
                        }
                        return arr;
                   })()
    ...
    app.post('/ajax_getsection', function(req, res){
      var sec;
      if (req.method === 'POST') {
            req.on('data', function (data) {
                console.log("Post data : " + data);
